...
# load datasets
covar_df <- read_csv(sprintf("%s/derivatives/gn-reduced/covariate.csv", PATH))
socio_df <- read_csv(sprintf("%s/derivatives/gn-reduced/sociocult.csv", PATH))
rsfc_df <- read_csv(sprintf("%s/derivatives/gn-reduced/rsfc.csv", PATH))
